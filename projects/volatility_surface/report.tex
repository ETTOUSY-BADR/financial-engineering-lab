...
\hypersetup{
  ...
  urlcolor=blue,
  citecolor=blue,
  pdftitle={An Arbitrage-Aware SPX Volatility Surface},
  pdfauthor={Badr Ettousy},
  pdfsubject={Financial engineering research: constrained SVI and Heston validation}
}
\pagestyle{fancy}
\fancyhf{}
...
\author{\textbf{Badr Ettousy}\\Financial Engineering Lab}
...
\resizebox{\textwidth}{!}{\input{output/tables/parity.tex}}
\end{table}
...
\resizebox{\textwidth}{!}{\input{output/tables/svi_diagnostics.tex}}
\end{table}
...
\resizebox{.82\textwidth}{!}{\input{output/tables/heston_parameters.tex}}
\end{table}
...
\resizebox{\textwidth}{!}{\input{output/tables/heston_validation.tex}}
\end{table}
